...
export function CatalogClient({ videos }: CatalogClientProps) {
              ...
              >
                <div className="relative aspect-video w-full bg-zinc-800">
                  {video.thumbnailUrl ? (
                    ...
                    <div className="flex h-full w-full items-center justify-center bg-linear-to-br from-zinc-800 to-zinc-900 text-xs font-medium uppercase tracking-wide text-zinc-500">
                      Match thumbnail
                    </div>
                  )}
                </div>
